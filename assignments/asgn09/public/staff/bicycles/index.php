...
<div id="content">
  <div class="bicycles listing">
    ...
    <div class="actions">
      <a class="action" href="<?php echo urlFor('/staff/bicycles/new.php'); ?>">Add Bicycle</a>
    </div>
      ...
      <?php foreach($bicycles as $bicycle) { ?>
        <tr>
          ...
          <td><a class="action" href="<?php echo urlFor('/staff/bicycles/show.php?id=' . h(u($bicycle->id))); ?>">View</a></td>
          <td><a class="action" href="<?php echo urlFor('/staff/bicycles/edit.php?id=' . h(u($bicycle->id))); ?>">Edit</a></td>
          <td><a class="action" href="<?php echo urlFor('/staff/bicycles/delete.php?id=' . h(u($bicycle->id))); ?>">Delete</a></td>
    	  </tr>
      <?php } ?>
  	</table>
