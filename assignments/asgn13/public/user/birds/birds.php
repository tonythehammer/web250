...
<table border="1">
  ...
  <?php foreach ($birds as $bird) { ?>
    ...
    <tr>
      ...
      <td><a class="action" href="<?php echo urlFor('user/birds/edit.php?id=' . h(u($bird->id))); ?>">Edit</a></td>
      <td><a class="action" href="<?php echo urlFor('user/birds/delete.php?id=' . h(u($bird->id))); ?>">Delete</a></td>
    </tr>
  <?php } ?>
</table>
